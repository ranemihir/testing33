    ...
    <main className="min-h-screen bg-gradient-to-br from-red-50 via-white to-rose-50">
      <div className="flex items-center justify-center min-h-screen p-8">
        <div className="text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 bg-clip-text text-transparent mb-6 hover:scale-105 transition-transform duration-300 ease-in-out">
            Hello World
          </h1>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg p-6 max-w-md mx-auto border border-white/20 hover:shadow-xl transition-shadow duration-300">
            <p className="text-gray-700 text-lg">
              Built with <span className="font-semibold text-red-600">Next.js</span> and styled with <span className="font-semibold text-rose-600">Tailwind CSS</span>
            </p>
